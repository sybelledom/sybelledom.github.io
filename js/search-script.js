...
!(function () {
  ...
  var l = {
    put: function z (t) {
      ...
      if (
        (function e (t) {
          return (
            Boolean(t) && Object.prototype.toString.call(t) === '[object Array]'
          )
        })(t)
      ) {
        return (function i (t) {
  ...
  function c (t) {
    return Boolean(t) && Object.prototype.toString.call(t) === '[object Object]'
  }
  function s (t) {
    return o.push(t), o
  }
  ...
  var h = {
    ...
    setOptions: function C (t) {
      ...
      typeof t.middleware === 'function' && (m.middleware = t.middleware)
    }
  }
  ...
  var v = {
    merge: function L (t, e) {
      var n = {}
      for (var r in t) {
        ;(n[r] = t[r]), typeof e[r] !== 'undefined' && (n[r] = e[r])
      }
      return n
    },
    isJSON: function M (t) {
  ...
  !(function (t) {
    ...
    function i (t) {
      ...
      (function e () {
        o.searchInput.addEventListener('keyup', function (t) {
          ;(function e (t) {
            return [13, 16, 20, 37, 38, 39, 40, 91].indexOf(t) === -1
    ...
    function c (t) {
      ;(function e (t) {
        ...
        (function i (t, e) {
          var n = t.length
          if (n === 0) return a(o.noResultsText)
